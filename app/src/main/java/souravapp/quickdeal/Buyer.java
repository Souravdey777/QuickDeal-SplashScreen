...
public class Buyer extends AppCompatActivity {
    ...
    public static String [] OPTIONS={"Full Name","Email Address","Phone Numer","City"};
    public static String [] Inputhint={"Enter Your Number","Enter Your Mail ID","Enter Your Phone Number","Location"};
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lv.setAdapter(new CustomAdapter(this, OPTIONS,Inputhint,OPTION_IMAGES));
...
class CustomAdapter extends BaseAdapter {
    ...
    public CustomAdapter(final Buyer activity, String[] Option, String[] Input_hint, int[] Images) {
